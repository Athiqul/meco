...
<main class="main">
    {{-- home slider --}}
     @include('frontend.components.home_slider')
    <!--End hero slider-->
    {{-- featured category --}}
    @include('frontend.components.feature_cat')
    <!--End category slider-->
   ...
   @include('frontend.components.product_tab')
    <!--Products Tabs-->
...
@include('frontend.components.vendor_list')
