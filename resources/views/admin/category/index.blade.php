                            ...
                            <table id="example" class="table table-striped table-bordered dataTable" style="width: 100%;"
                                ...
                                <tbody>
                                   ...
                                   <tr role="row" class="odd">
                                    ...
                                    <td> <img src="{{$item->image?asset('assets/images/category/'.$item->image):asset('assets/images/profile/no_image.jpg')}}" alt="brand_image" style="width: 30px;height:30px"></td>
                                    <td>
                                        <a href="{{route('admin.category.edit',$item->id)}}" class="btn btn-info" title="Edit">
                                            <i class="fadeIn animated bx bx-pencil"></i>
                                        </a>
                                        <a href="{{route('admin.category.delete',$item->id)}}" class="btn btn-danger" id="catDelete" title="Delete">
